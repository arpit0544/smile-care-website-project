          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
              {treatmentsData.map((treatment, index) => (
                <div 
                  key={index} 
                  className="treatment-card overflow-hidden rounded-lg cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl"
                ...
                >
                  ...
                  <div className="p-6 bg-white">
                    <h3 className="text-xl font-bold mb-2 text-dental-blue flex items-center group">
                      <Activity size={20} className="mr-2 group-hover:animate-bounce" />
                      {treatment.title}
                    </h3>
